try:
    ...
    if platform.system() != "Linux":
        print("Programa feito para Linux, pode falhar em outros sistemas operacionais. ")
    import os
    print("Instalando dependências... ")
    os.system("sudo apt install portaudio19-dev -y")
    os.system("pip install SpeechRecognition gtts playsound pyaudio")
    print()
    print('Instalação de dependências concluída, por favor, inicie o programa novamente. ')
    exit()
